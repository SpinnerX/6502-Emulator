 ...
 * 
 * Control (Mode)
 * - Zero (0) means go in addition mode, One(1) means go in subtraction mode.
 * => Multiplexor
 *      - Basically chooses one of the several inputs based on the control line and send the chosen input to the output
 * 
 * 
 * 
 * 
